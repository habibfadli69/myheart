...
module.exports = {
    createDokter : async(req,res) => {
        ...
        try {
            response.setData(await dokterRepositories.createDokter(req.body.idDokter, req.body.namaDokter, req.body.emailDokter, req.body.passwordDokter, req.body.birthdayDokter, req.body.umurDokter, req.body.alamatDokter, req.body.tinggiDokter, req.body.beratDokter, req.body.notelpDokter))
        } catch(e) {
